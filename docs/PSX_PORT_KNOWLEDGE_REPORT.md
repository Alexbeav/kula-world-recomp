# Kula World knowledge report

- Date: 2026-08-31
- Retail identity: Europe PAL `SCES-01000`
...
The source now uses `Kula_World_Recompiled` as the only setup executable name. The batch source
