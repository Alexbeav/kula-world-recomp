...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/kula-world-recomp/total)](https://github.com/Alexbeav/kula-world-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/kula-world-recomp/latest/total)](https://github.com/Alexbeav/kula-world-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/kula-world-recomp)](https://github.com/Alexbeav/kula-world-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Kula World** built on
[psxrecomp](https://github.com/Alexbeav/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

A native recompilation setup host for Kula World.
...
Zip prefix for CI artifacts: `Kula-World-Recomp`.
...
The `v0.3.3` source uses `Kula_World_Recompiled` in CMake, the setup relaunch, and the packager.
